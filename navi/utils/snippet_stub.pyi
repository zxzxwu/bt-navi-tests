...
class BluetoothSnippet(snippet_client_v2.SnippetClientV2):
  ...
  def registerPlayerListener(self, player_id: str | None = None) -> callback_handler_v2.CallbackHandlerV2: ...
  ...
  def getHidHostReport(self, address: str, report_type: int, report_id: int, buffer_size: int) -> list[int]: ...
  ...
  # AICS
  def registerAicsCallback(self, address: str, instance_id: int) -> callback_handler_v2.CallbackHandlerV2: ...
