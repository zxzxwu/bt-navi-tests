...
class BluetoothSnippet(snippet_client_v2.SnippetClientV2):
  ...
  def getFullSdkVersion(self) -> int: ...
  def registerVoiceCommandCallback(
      self,
  ) -> callback_handler_v2.CallbackHandlerV2: ...
  ...
  def getBondStatus(
      self, address: str, transport: int
  ) -> dict[str, Any] | None: ...
  def getAddress(self) -> str: ...
  def getIdentityAddress(self, address: str) -> str | None: ...
  ...
  def disconnectAcl(self, address: str, transport: int) -> int: ...
  ...
  def startTakSession(
      self, address: str, key_list: list[int], uuid: str
  ) -> callback_handler_v2.CallbackHandlerV2: ...
  ...
  def setA2dpCodecConfig(
      self, address: str, codec_config: dict[str, Any]
  ) -> None: ...
  def setA2dpOptionalCodecsEnabled(
      self, address: str, enabled: int
  ) -> None: ...
  def getA2dpSupportedCodecTypes(self) -> list[dict[str, Any]]: ...
  # GATT Client
  def gattConnect(
      self,
      address: str,
  ...
  def gattBeginReliableWrite(self, cookie: str) -> bool: ...
  def gattExecuteReliableWrite(self, cookie: str) -> bool: ...
  def gattAbortReliableWrite(self, cookie: str) -> None: ...
  # GATT Server
  ...
  def gattServerRemoveService(self, cookie: str, uuid: str) -> bool: ...
  ...
  def l2capConnect(
      ...
      psm: int,
      address_type: int = android_constants.AddressTypeStatus.RANDOM,
      transport: int = android_constants.Transport.LE,
      blocking: bool = True,
  ) -> str: ...
  def l2capOpenServer(
      self,
  ...
  # RFCOMM
  def rfcommConnect(
      self, address: str, secure: bool, uuid: str, blocking: bool = True
  ) -> str: ...
  def socketWaitForConnectionComplete(
      self, cookie: str, timeout_milliseconds: int = 10_000
  ) -> None: ...
  def rfcommOpenServer(self, secure: bool, uuid: str) -> str: ...
  # Unified Sockets
  def socketAccept(self, server_cookie: str) -> str: ...
  def socketClose(self, cookie: str) -> None: ...
  def socketRead(
      self, cookie: str, bytes_to_read: int | None = None
  ) -> str: ...
  def socketWrite(self, cookie: str, data: str) -> None: ...
  def socketAvailable(self, cookie: str) -> int: ...
  def socketIsConnected(self, cookie: str) -> bool: ...
  def socketConnectWithSettings(
      self,
      address: str,
      address_type: int = android_constants.AddressTypeStatus.RANDOM,
      settings: dict[str, Any] = ...,
  ) -> str: ...
  def socketListenWithSettings(
      self,
      settings: dict[str, Any],
  ) -> list[Any]: ...
  # Audio
  ...
  def audioPlayFile(
      self, fileUri: str, player_id: str | None = None
  ) -> None: ...
  def audioSetRepeat(
      self, repeatMode: int, player_id: str | None = None
  ) -> None: ...
  def setShuffleMode(
      self, enabled: bool, player_id: str | None = None
  ) -> None: ...
  ...
  def setCommunicationDevice(
      self, device_type: int | None = None, address: str | None = None
  ) -> bool: ...
  def addMediaItem(
      self, media_item: dict[str, Any], player_id: str | None = None
  ) -> None: ...
  def playMediaItem(
      self, media_item: dict[str, Any], player_id: str | None = None
  ) -> None: ...
  def setAudioPlaybackOffload(
      self, enabled: bool, player_id: str | None = None
  ) -> None: ...
  def setHandleAudioBecomingNoisy(
      self, enabled: bool, player_id: str | None = None
  ) -> None: ...
  def startRecording(
      self,
  ...
  def setAudioParameters(self, parameters: str) -> None: ...
  def setAudioMode(self, mode: int) -> None: ...
  def getAudioMode(self) -> int: ...
  def getMicrophoneMuteState(self) -> bool: ...
  def setMicrophoneMuteState(self, is_mute: bool) -> None: ...
  def registerPlayerListener(
  ...
  def addCompatibleSpatizlierDevice(
      self, role: int, device_type: int, address: str
  ) -> None: ...
  def removeCompatibleSpatizlierDevice(
      self, role: int, device_type: int, address: str
  ) -> None: ...
  def clearCompatibleSpatizlierDevices(self) -> None: ...
  def setHeadtrackerEnabled(
      self, role: int, device_type: int, address: str, enabled: bool
  ) -> None: ...
  def getHeadtrackerEnabled(
      self, role: int, device_type: int, address: str
  ) -> bool: ...
  def audioRegisterHeadTrackerCallback(
      self,
  ) -> callback_handler_v2.CallbackHandlerV2: ...
  def audioUnregisterHeadTrackerCallback(self, callback_id: str) -> None: ...
  def getSupportedAudioDeviceTypes(
      self, direction: android_constants.AudioDeviceRole
  ) -> list[int]: ...
  ...
  def disconnectAllCalls(self) -> None: ...
  def requestCallEndpointSwitch(
      self,
      cookie: str,
      endpoint_type: android_constants.CallEndpointType | None = None,
      endpoint_identifier: str | None = None,
  ) -> None: ...
  def getAvailableCallEndpoints(self) -> list[dict[str, Any]]: ...
  ...
  def setPhoneAccountEnabled(
      self, package_name: str, class_name: str, account_id: str, enabled: bool
  ) -> None: ...
  def setUserSelectedOutgoingPhoneAccount(
      self,
      package_name: str | None = None,
      class_name: str | None = None,
      account_id: str | None = None,
  ) -> None: ...
  def registerPhoneAccount(
      self,
      package_name: str,
      class_name: str,
      account_id: str,
  ...
  def unregisterHidDeviceApp(self) -> None: ...
  def getHidDeviceConnectedDevices(self) -> list[str]: ...
  def getHidDeviceDevicesMatchingConnectionStates(
      self, states: list[int]
  ) -> list[str]: ...
  def getHidDeviceConnectionState(self, address: str) -> int: ...
  def hidDeviceSendReport(
      self, address: str, id: int, data: list[int]
  ) -> bool: ...
  def hidDeviceReplyReport(
      self, address: str, type: int, id: int, data: list[int]
  ) -> bool: ...
  ...
  def setHidHostPreferredTransport(
      self, address: str, transport: int
  ) -> bool: ...
  ...
  def getHidHostReport(
      self, address: str, report_type: int, report_id: int, buffer_size: int
  ) -> list[int]: ...
  def setHidHostReport(
      self, address: str, report_type: int, report: str
  ) -> bool: ...
  ...
  def getProfileConnectionState(self, profile: int, address: str) -> int: ...
  def getProfileConnectedDevices(self, profile: int) -> list[str]: ...
  def getProfileDevicesMatchingConnectionStates(
      self, profile: int, states: list[int]
  ) -> list[str]: ...
  def waitForProfileReady(self, profile: int) -> None: ...
  # Broadcast
  def startBroadcast(
      self,
  ...
  def registerVolumeControlCallback(
      self,
  ) -> callback_handler_v2.CallbackHandlerV2: ...
  def unregisterVolumeControlCallback(self, callback_id: str) -> None: ...
  def setVolumeOffset(
      self, address: str, instance_id: int, volume_offset: int
  ) -> None: ...
  ...
  def vcpSetDeviceVolume(
      self, address: str, volume: int, is_group_operation: bool
  ) -> None: ...

  # AICS
  def registerAicsCallback(
      self, address: str, instance_id: int
  ) -> callback_handler_v2.CallbackHandlerV2: ...
  ...
  def aicsIsDescriptionWritable(
      self, address: str, instance_id: int
  ) -> bool: ...
  def aicsSetDescription(
      self, address: str, instance_id: int, description: str
  ) -> bool: ...
  ...
  def registerMediaControllerCallback(
      self, cookie: str
  ) -> callback_handler_v2.CallbackHandlerV2: ...
  def setMediaControllerRepeatMode(
      self, cookie: str, repeat_mode: int
  ) -> None: ...
  def setMediaControllerShuffleMode(
      self, cookie: str, shuffle_mode: int
  ) -> None: ...
  # CSIP Set Coordinator
  def registerCsipSetCoordinatorCallback(
      self,
  ) -> callback_handler_v2.CallbackHandlerV2: ...
  def unregisterCsipSetCoordinatorCallback(self, callback_id: str) -> None: ...
  def getCsipGroupUuidMapByDevice(self, address: str) -> dict[int, str]: ...
  def getCsipAllGroupIds(self, uuid_str: str | None) -> list[int]: ...
  def setCsipConnectionPolicy(self, address: str, policy: int) -> bool: ...
