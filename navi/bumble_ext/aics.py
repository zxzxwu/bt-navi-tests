...
class AudioInputControlService(gatt.TemplateService):
  ...
  gain_settings_properties_characteristic: Characteristic[
  ...
  def __init__(
      ...
      gain_settings_properties: (
          aics.GainSettingsProperties | None
      ) = None,
      ...
      audio_input_description: (
          aics.AudioInputDescription | None
      ) = None,
  ):
    ...
    self.audio_input_state = (
        ...
        if audio_input_state is None
        else audio_input_state
    )
    ...
    self.audio_input_description = (
        aics.AudioInputDescription()
        if audio_input_description is None
        else audio_input_description
    )

    self.audio_input_control_point = aics.AudioInputControlPoint(
    ...
    self.audio_input_description_characteristic = (
        gatt_adapters.UTF8CharacteristicAdapter(
            Characteristic(
