...
class BluetoothHidHostSnippet : Snippet {
        ...
        override fun onReceive(context: Context, intent: Intent) {
          ...
          when (intent.action) {
            ...
            HID_HOST_ACTION_HANDSHAKE ->
              Utils.postSnippetEvent(callbackId, SnippetConstants.HID_HOST_HANDSHAKE) {
                putString(SnippetConstants.FIELD_DEVICE, device?.address)
  ...
  fun getHidHostReport(address: String, reportType: Int, reportId: Int, bufferSize: Int): Boolean {
    val device = bluetoothAdapter.getRemoteDevice(address)
    return BluetoothHidHost::class
      .java
      .getMethod(
  ...
  fun setHidHostReport(address: String, reportType: Int, report: String): Boolean {
    ...
    return BluetoothHidHost::class
      .java
      .getMethod("setReport", BluetoothDevice::class.java, Byte::class.java, String::class.java)
