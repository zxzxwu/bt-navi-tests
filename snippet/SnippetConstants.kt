...
object SnippetConstants {
    ...
    const val FIELD_PREVIOUS_STATE = "previous_state"
    ...
    const val FIELD_ARTWORK_URI = "artwork_uri"
    const val FIELD_BUFFER_SIZE = "bufferSize"
    ...
    const val FIELD_IS_SOURCE = "is_source"
    const val FIELD_IS_SINK = "is_sink"
    const val FIELD_REPORT = "report"
    const val FIELD_IDLE_TIME = "idle_time"
    const val FIELD_PROTOCOL_MODE = "protocol_mode"
    ...
    const val HID_DEVICE_APP_STATUS_CHANGED = "HID_DEVICE_APP_STATUS_CHANGED"
    const val HID_DEVICE_ON_GET_REPORT = "onGetReportRequest"
    const val ACTIVE_DEVICE_CHANGED = "ACTIVE_DEVICE_CHANGED"
    const val TAK_STATE_CHANGED = "TakStateChanged"
    ...
    const val GATT_FIELD_INTERVAL = "interval"
    const val GATT_FIELD_LATENCY = "latency"
    const val GATT_FIELD_SUPERVISION_TIMEOUT = "supervision_timeout"
    ...
    const val GATT_CONNECTION_UPDATED = "GATT_CONNECTION_UPDATED"
    ...
    const val GATT_FIELD_EXECUTE = "execute"
    ...
    const val GATT_SERVER_EXECUTE_WRITE = "GATT_SERVER_EXECUTE_WRITE"
    const val GATT_SERVER_MTU_CHANGED = "GATT_SERVER_MTU_CHANGED"
    const val GATT_SERVER_CONNECTION_UPDATED = "GATT_SERVER_CONNECTION_UPDATED"
    ...
    const val HEAD_TRACKER_AVAILABLE_CHANGED = "HEAD_TRACKER_AVAILABLE_CHANGED"
    const val MODE = "mode"
    ...
    const val CALL_ENDPOINT_CHANGED = "CALL_ENDPOINT_CHANGED"
    ...
    const val CALL_REMOVED = "CALL_REMOVED"
    ...
    const val CSIS_SET_MEMBER_AVAILABLE = "CSIS_SET_MEMBER_AVAILABLE"
    ...
    const val HID_HOST_PROTOCOL_MODE_CHANGED = "HID_HOST_PROTOCOL_MODE_CHANGED"
    ...
    const val SOCKET_SETTINGS_ENCRYPTION_REQUIRED = "encryption_required"
    const val SOCKET_SETTINGS_AUTHENTICATION_REQUIRED = "authentication_required"
    const val SOCKET_SETTINGS_L2CAP_PSM = "l2cap_psm"
    const val SOCKET_SETTINGS_SOCKET_TYPE = "socket_type"
    const val SOCKET_SETTINGS_RFCOMM_UUID = "rfcomm_uuid"
    const val SOCKET_SETTINGS_RFCOMM_SERVICE_NAME = "rfcomm_service_name"
    const val GATT_RELIABLE_WRITE_COMPLETED = "GATT_RELIABLE_WRITE_COMPLETED"
    const val DISCOVERY_STARTED = "DISCOVERY_STARTED"
    const val DISCOVERY_FINISHED = "DISCOVERY_FINISHED"
}