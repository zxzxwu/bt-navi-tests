...
class BluetoothL2capSnippet : Snippet {
   ...
   * encrypt if [secure] is true. [addressType] will be used to specify the type of remote address.
   */
  ...
  /**
   * Listens for L2CAP channel on [psm] requiring encryption if [secure], and returns the allocated
   * PSM.
   */
